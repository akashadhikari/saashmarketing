...
<html>
  <head>   
    ...
    <style type="text/css">
      ...
      /* Featured content */
      .featuredHeader {background: #00AEEF;}
        ...
        <tr>
          <td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" summary="" width="640" align="center">
              <tr>
                <td class="preheaderContent">Get in touch with Saash Marketing</td>
                <td class="webversion">Not done digital marketing Yet? <a href="saashmarketing.com" title="View the webversion">Visit our website</a></td>
              </tr>
            </table>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="640" align="center" summary="">
              <tr>
                <td class="logoContainer" align="center">
                  <a href="#" title="Saash">
                    <img class="logo" src="https://i.ibb.co/mRs8YBH/Webp-net-resizeimage-1.png" alt="Lorem logo" />
                  </a>
                </td>
              </tr>
            </table>
                ...
                <td class="column">
                  <table border="0" cellspacing="0" cellpadding="0" width="395" summary="">
                    ...
                    <tr>
                      ...
                      <h3>Thank you for having interest over our plan. </h3>
                    </tr>
                  </table>
                </td>
                <td id="featuredImage" class="column"><img src="https://i.imgur.com/yzoJ15a.png" width="234" alt="" /></td>
              </tr>
            </table>
          </td>
        </tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="200" align="left" summary="">
                    <tr>
                      <td class="sectionArticleImage">
                        <img src="https://i.imgur.com/k2u4o8V.png" width="150" alt="" />
                      </td>
                    </tr>
                    <tr><td class="sectionArticleTitle">Easy to use</td></tr>
                    <tr><td class="sectionArticleContent">We have the straight forward concept- trying to constantly battle between the deliver functionality & easy to use by our intended users in our finished products.<br /></td></tr>
                  </table>
                </td>
                <td class="column" valign="top">
                  <table border="0" cellpadding="0" cellspacing="0" width="200" align="center" summary="">
                    <tr>
                      <td class="sectionArticleImage">
                        <img src="https://i.imgur.com/dcyhNyI.png" width="150" alt="" />
                      </td>
                    </tr>
                    <tr><td class="sectionArticleTitle">Awesome Design</td></tr>
                    <tr><td class="sectionArticleContent">The software can be easy to maintain it has harmonious styling, immeasurable remarks, is constructive & easy to make changes to parts of the software without eradicating its functionality. Genuine software is reusable.<br /></td></tr>
                  </table>
                </td>
                <td class="column" valign="top">
                  <table border="0" cellpadding="0" cellspacing="0" width="200" align="center" summary="">
                    <tr>
                      <td class="sectionArticleImage">
                        <img src="https://i.imgur.com/Z5orZwv.png" width="150" alt="" />
                      </td>
                    </tr>
                    <tr><td class="sectionArticleTitle">Easy to customize</td></tr>
                    <tr><td class="sectionArticleContent">Has no unnecessary functions & saves time.
Very cost-Effective & Has a high degree of flexibility
easy to learn and use.<br /></td></tr>
                  </table>
                </td>
              </tr>
            </table>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" summary="">
        <tr>
          <td class="sectionEven">
            <table border="0" cellpadding="0" cellspacing="0" width="640" align="center" summary="">
              <tr><td class="sectionTitle">Digital Marketing?</td></tr>
              <tr><td class="sectionSubTitle">Grow your business with digital marketing</td></tr>
              <tr>
                <td class="buttonContainer">
                  <table border="0" cellpadding="0" cellspacing="0" summary="" width="30%" align="center">
                    <tr><td class="button"><a href="saashmarketing.com" title="ipsum">SAASH</a></td></tr>
                  </table>
                </td>
              </tr>
            </table>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="120" align="center" summary="">
              <tr>
                <td align="center" width="32">
                  <a href="https://www.twitter.com" title="Twitter"><img src="https://i.imgur.com/OP4C0nu.png" width="29" alt="Twitter" /></a>
                </td>
